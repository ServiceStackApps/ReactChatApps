                    ...
                    $(this.source).handleServerEvents({
                        ...
                        receivers: {
                            ...
                            windows: {
                                ...
                                dance: function () {
                                    _this.props.postMessage("/cmd.announce Lets Dance!");
                                    _this.props.postMessage("/tv.watch https://youtu.be/9bZkp7q19f0");
                                    setTimeout(function () {
                                        _this.props.postMessage("/css.background url(/img/disco.jpg)");
                                        ...
                                        setTimeout(function () {
                                            ...
                                            _this.props.postMessage("/css.background url(/img/bg.jpg)");
                                            _this.props.postMessage("/tv.off");
                                        }, 16000);
                                    }, 1000);
                                }
                            }
