    ...
    componentDidMount() {
        ...
        $(this.source).handleServerEvents({
            ...
            receivers: {
                ...
                windows: {
                    quit() { window.nativeHost.quit(); },
                    shrink() { window.nativeHost.shrink(); },
                    grow() { window.nativeHost.grow(); },
                    dance: () => {
                       this.props.postMessage("/cmd.announce Lets Dance!");
                       this.props.postMessage("/tv.watch https://youtu.be/9bZkp7q19f0");
                        setTimeout(() => {
                            this.props.postMessage("/css.background url(/img/disco.jpg)");
                            ...
                            setTimeout(() => {
                                ...
                                this.props.postMessage("/css.background url(/img/bg.jpg)");
                                this.props.postMessage("/tv.off");
                            }, 16000);
                        }, 1000);
                    }
                }
